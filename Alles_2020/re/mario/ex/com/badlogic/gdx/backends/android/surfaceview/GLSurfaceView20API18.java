...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18 {
  ...
  public GLSurfaceView20API18(Context paramContext, ResolutionStrategy paramResolutionStrategy) {
    super(paramContext);
    this.resolutionStrategy = paramResolutionStrategy;
    init(false, 16, 0);
  }
  
  public GLSurfaceView20API18(Context paramContext, boolean paramBoolean, int paramInt1, int paramInt2, ResolutionStrategy paramResolutionStrategy) {
    super(paramContext);
    this.resolutionStrategy = paramResolutionStrategy;
  ...
  private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
    ...
    private void printConfigs(EGL10 param1EGL10, EGLDisplay param1EGLDisplay, EGLConfig[] param1ArrayOfEGLConfig) {
      ...
      Log.w(GLSurfaceView20API18.TAG, String.format("%d configurations", new Object[] { Integer.valueOf(i) }));
      for (byte b = 0; b < i; b++) {
    ...
    public EGLConfig chooseConfig(EGL10 param1EGL10, EGLDisplay param1EGLDisplay, EGLConfig[] param1ArrayOfEGLConfig) {
      ...
      for (byte b = 0; b < i; b++) {
        ...
        if (j >= this.mDepthSize && k >= this.mStencilSize) {
          ...
          if (k == this.mRedSize && m == this.mGreenSize && j == this.mBlueSize && n == this.mAlphaSize)
            return eGLConfig; 
        } 
      } 
      return null;
  ...
  static class ContextFactory implements GLSurfaceViewAPI18.EGLContextFactory {
    ...
    public EGLContext createContext(EGL10 param1EGL10, EGLDisplay param1EGLDisplay, EGLConfig param1EGLConfig) {
      ...
      GLSurfaceView20API18.checkEglError("Before eglCreateContext", param1EGL10);
      ...
      GLSurfaceView20API18.checkEglError("After eglCreateContext", param1EGL10);
      return eGLContext;
    }
...
/* Location:              /home/r00tus3r/ctfs/2020/alles/re/prehistoric-mario-dex2jar.jar!/com/badlogic/gdx/backends/android/surfaceview/GLSurfaceView20API18.class
