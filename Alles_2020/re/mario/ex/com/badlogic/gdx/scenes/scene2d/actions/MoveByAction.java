...
public class MoveByAction extends RelativeTemporalAction {
  ...
  protected void updateRelative(float paramFloat) { this.target.moveBy(this.amountX * paramFloat, this.amountY * paramFloat); }
}


/* Location:              /home/r00tus3r/ctfs/2020/alles/re/prehistoric-mario-dex2jar.jar!/com/badlogic/gdx/scenes/scene2d/actions/MoveByAction.class
